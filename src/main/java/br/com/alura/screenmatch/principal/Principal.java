...
public class Principal {
    ...
    private void buscarSerieWeb() {
        ...
        repositorio.save(serie); //Persiste no banco de dados
    ...
    private void listarSeriesBuscadas() {
        series = repositorio.findAll(); //Retorna todos os registros do banco de dados
        series.stream()
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Deseja buscar séria de qual categoria?");
